        ...
        <tbody>
          {filter?.map((bill) => (
            <tr key={bill.datetime}>
              ...
              <td>
                <span className='text-primary' style={{ cursor: "pointer" }} onClick={e => { dispatch(viewBill({ tabIndex: `${bill.id}`, data: bill })); navigate(`/view/${bill.id}`); }}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
